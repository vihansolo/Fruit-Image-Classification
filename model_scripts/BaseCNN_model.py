...
def func_cnn_model():
    ...
    model = Sequential([
        ...
        layers.Conv2D(200, 9, padding='same', activation='relu'),
        layers.MaxPool2D(),
...
if __name__ == '__main__':
    ...
    graph = cnn_model.fit(X_train, Y_train, batch_size=10, epochs=50, verbose=1, validation_data=(X_test, Y_test))
    ...
    cnn_model.save('Models/BaseCNN.h5')
